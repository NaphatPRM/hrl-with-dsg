...
def get_exploration_agent(rnd_base_dir, env_name):
	...
	return create_runner(rnd_base_dir, create_agent, level_name=env_name, schedule="episode_wise")
...
if __name__ == "__main__":
	...
	exploration_agent = get_exploration_agent(_rnd_base_dir, args.environment_name)
